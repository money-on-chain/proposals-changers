...
describe('FeesAndBitprorateProposal', function () {
  ...
  it('execute() applies on MoC V1 & ROC V2 (rates + fees)', async () => {
    ...
    const readRocFee = async (k) => {
      switch (k) {
        case ROC_KEYS.TcMintFee:        return rocV2.tcMintFee();
        case ROC_KEYS.TcRedeemFee:      return rocV2.tcRedeemFee();
        case ROC_KEYS.SwapTPforTPFee:   return rocV2.swapTPforTPFee();
        case ROC_KEYS.SwapTPforTCFee:   return rocV2.swapTPforTCFee();
        case ROC_KEYS.SwapTCforTPFee:   return rocV2.swapTCforTPFee();
        case ROC_KEYS.RedeemTCandTPFee: return rocV2.redeemTCandTPFee();
        case ROC_KEYS.MintTCandTPFee:   return rocV2.mintTCandTPFee();
        case ROC_KEYS.FeeTokenPct:      return rocV2.feeTokenPct();
