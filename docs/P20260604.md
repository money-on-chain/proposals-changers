...
| :----------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------: |
| `BufferPctAndCleanMocV1` | [`0x0000000000000000000000000000000000000000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `CoinPairPrice`   | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `OracleManager`   | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `MocV1`           | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `MocStateV1`      | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `MocExchangeV1`   | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| `MocSettlementV1` | New implementation | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD |
...
| Name                         | Address                                                                                                                  | Why?                                                                  |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| `newMaxAbsoluteOpProvider`   | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD | [Monitoring improvements](#42-flux-capacitor-monitoring-improvements) |
| `newMaxOpDifferenceProvider` | [`0x00000...0000`](https://rootstock.blockscout.com/address/0x0000000000000000000000000000000000000000?tab=contract) TBD | [Monitoring improvements](#42-flux-capacitor-monitoring-improvements) |
