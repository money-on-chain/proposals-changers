...
contract FeesAndBitprorateProposal is IChangeContract {
    ...
    function commissionRatesBlobRaw() external view returns (bytes memory) { return commissionRatesBlob; }
    function rocV2FeeBlobRaw() external view returns (bytes memory) { return rocV2FeeBlob; }
