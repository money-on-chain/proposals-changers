...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface MocHelperInterface extends Interface {
  ...
  export interface MocHelper extends BaseContract {
    
    connect(runner?: ContractRunner | null): MocHelper;
    waitForDeployment(): Promise<this>;

    interface: MocHelperInterface;
