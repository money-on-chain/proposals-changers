...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IChangeContractInterface extends Interface {
  ...
  export interface IChangeContract extends BaseContract {
    
    connect(runner?: ContractRunner | null): IChangeContract;
    waitForDeployment(): Promise<this>;

    interface: IChangeContractInterface;
